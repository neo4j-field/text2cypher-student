...
from agents.components.text2cypher.validation.models import ValidateCypherOutput
from agents.components.text2cypher.validation.prompts import (
...
def create_text2cypher_validation_node(
    ...
    def validate_cypher(state: CypherState) -> CypherState:
        """
